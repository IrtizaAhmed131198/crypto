            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if($row->status == 1){
                        ...
                        $editButton = '<a href="javascript::void(0)" class="btn btn-info btn-custom mr-2">Payment Complete</a>';
                    }else if($row->status == 3){
                        $editButton = '<a href="javascript::void(0)" class="btn btn-info btn-custom mr-2">Expire</a>';
                    }else{
                        $editButton = '<a href="javascript::void(0)" class="btn btn-info btn-custom mr-2">Payment Complete</a>';
                    }
