            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-slides owl-carousel owl-theme">
                        <div class="item">
                            <div class="flex flex-justify-between flex-align-center banner"
                                style="background-color: black !important">
                                <div>
                                    <h1 class="text-4xl text-white mb-2">Assign expert to</h1>
                                    <h1 class="text-4xl text-white mb-4">Manage Dashboard</h1>
                                    <div class="banner__cta">
                                        <button class="button bg-secondary text-white"
                                            style=" padding: 13px; border-radius: 16px; ">Find
                                            expert</button>
                                    </div>
                                </div>
                        ...
                        <div class="item">
                            <div class="flex flex-justify-between flex-align-center banner"
                                ...
                                <div class="banner__img">
                                    <img src="{{ asset('public/assets/imgs/fb6ac731ce6d416965c2c50623d869d3-removebg-preview.png') }}"
                                        alt="banner">
                                </div>
                            </div>
                        </div>
    ...
    <section class="container-fluid">
        ...
        <div class="portos">
            <div class="flex flex-justify-between flex-align-center bg-white porto">
                <svg width="48" height="48" viewBox="20 20 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="mr-2">
                    ...
                    <defs>
                        <filter id="filter0_d_1_55" x="0" y="0" width="88" height="88" filterUnits="userSpaceOnUse"
                            ...
                            <feColorMatrix type="matrix"
                                values="0 0 0 0 0.5586 0 0 0 0 0.560629 0 0 0 0 0.57 0 0 0 0.04 0"></feColorMatrix>
                ...
                <div class="mt-1">
                    ...
                    <div class="flex flex-align-center flex-justify-between">
                        ...
                        <small class="flex flex-align-center text-error"><svg width="20" height="20"
                                viewBox="5 5 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="flex flex-justify-between flex-align-center bg-white porto">
                ...
                <div class="mt-1">
                    ...
                    <div class="flex flex-align-center flex-justify-between">
                        ...
                        <small class="flex flex-align-center text-success"><svg width="20" height="20"
    ...
    <section class="revenue">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="about-crpty">
                        <h3>About US.</h3>
                        <p>Bitcoin (BTC) is the first and most widely recognized cryptocurrency, created by an anonymous entity known as Satoshi Nakamoto in 2009. It operates on a decentralized, peer-to-peer network using blockchain technology, ensuring secure, transparent, and immutable transactions. Bitcoin is often referred to as "digital gold" due to its limited supply of 21 million coins and its role as a store of value. It is widely used for investment, remittances, and as an alternative to traditional fiat currencies.</p>
                        <p>Ethereum (ETH) is a decentralized platform introduced by Vitalik Buterin in 2015, known for its smart contract functionality. Unlike Bitcoin, which primarily serves as a digital currency, Ethereum enables developers to build decentralized applications (DApps) and execute self-executing contracts without intermediaries. Ethereum powers a vast ecosystem of decentralized finance (DeFi), non-fungible tokens (NFTs), and blockchain-based innovations. With its transition to Ethereum 2.0, it now operates on a Proof-of-Stake (PoS) mechanism, enhancing scalability, security, and energy efficiency.</p>
                        <p>Both Bitcoin and Ethereum play crucial roles in the evolving cryptocurrency landscape, offering different use cases while driving the adoption of blockchain technology.</p>
                    </div>
                </div>
            </div>
        </div>
