    ...
    <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="background-color: #ffffff; margin: 20px auto; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        <tr>
            <td align="center" style="padding: 10px;">
                ...
                <img src="{{ asset('public/assets/logo/logo.jpg') }}" alt="Logo" style="max-width: 100px; height: 100px;">
            </td>
        </tr>
        <tr>
            <td align="center" style="text-align: center;">
                <h1 style="margin-top: 20px;">Subcribe Email</h1>
            </td>
        </tr>
        <tr>
            <td style="text-align: left; padding: 20px;">
                <h1>Thank You for Subscribing!</h1>
                <p>We're excited to have you with us. Stay tuned for the latest updates and job opportunities.</p>
            </td>
        </tr>
        <tr>
